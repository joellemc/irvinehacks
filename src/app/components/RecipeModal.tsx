        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-800 mb-3 flex items-center gap-2">
              <div className="w-6 h-6 bg-celadon-100 rounded-full flex items-center justify-center">
                <Check className="w-4 h-4 text-celadon-400" />
              </div>
          ...
          {ingredientsYouNeed.length > 0 && (
            <div>
              <h3 className="text-lg font-bold text-slate-800 mb-3 flex items-center gap-2">
                <div className="w-6 h-6 bg-celadon-100 rounded-full flex items-center justify-center">
                  <Plus className="w-4 h-4 text-celadon-400" />
                </div>
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${isInGroceries(ingredient)
                          ...
                          : 'bg-bright-lavender-200 text-bright-lavender-900 hover:bg-bright-lavender-300'
                        }
                      `}
                    >
            ...
            <ol className="space-y-4">
              {recipe.instructions.map((step, index) => (
                <li key={index} className="flex gap-4">
                  <div className="flex-shrink-0 w-8 h-8 bg-celadon-400 text-white rounded-full flex items-center justify-center font-bold text-sm">
                    {index + 1}
                  </div>
